    ...
    <div className="w-full bg-white py-16 px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p>
            No matter where you live we can find a specialized online tutor for
            you through our 1:1 tutoring program. Location is no longer a
            barrier as you can find help whether you are an elementary,
            secondary, or college student. Students receive a tailored program
            and support, while also achieving the same benefit of working at
